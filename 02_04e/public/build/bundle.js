...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$2, 111, 6, 2025);
    			attr_dev(div, "class", "success svelte-xtseyo");
    			add_location(div, file$2, 109, 4, 1988);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 130, 6, 2609);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(li, file$2, 132, 10, 2684);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$2, 107, 0, 1919);
    		},
    ...
    class Login extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { submit: 6 });
    ...
    /* src/event.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 18, 0, 402);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*mySecondEvent*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    /* src/forward.svelte generated by Svelte v3.49.0 */

    function create_fragment$1(ctx) {
    	let event;
    	let current;
    	event = new Event({ $$inline: true });
    	event.$on("message", /*forward*/ ctx[0]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Forward> was created with unknown prop '${key}'`);
    	});
    ...
    class Forward extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	let login;
    	let current;
    	forward = new Forward({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "An event Listener, click the button below";
    			t1 = space();
    			create_component(forward.$$.fragment);
    			t2 = space();
    			section = element("section");
    			create_component(login.$$.fragment);
    			add_location(h1, file, 35, 0, 665);
    			attr_dev(section, "class", "svelte-18mwdm6");
    			add_location(section, file, 43, 0, 898);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
